        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">Importar planilha de dados da <b style="color: #869791;font-size: 35px">PESQUISA</b></h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-10">
                                <!-- Formulário -->
                                <form action="{{route('semestre.pesquisa_import')}}"  method="POST" enctype="multipart/form-data" onsubmit="return validarFormulario()">
                                    @csrf
