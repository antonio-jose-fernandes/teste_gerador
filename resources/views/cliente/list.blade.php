...
@endsection
@section('pesquisa')
  <form action="{{route('cliente.search')}}" method="get" id="pesquisar">
    @csrf
    <div class="input-group no-border">
      <input type="text" class="form-control" placeholder="Pesquisar..." name="filtro" id="filtro" @if(isset($filtro))
      value="{{$filtro}}" @endif>
                        ...
                        <tr>
                          ...
                          <td>
                            <a rel="tooltip" title="Editar" class="btn btn-link" data-original-title="Edit"
                              href="{{route('cliente.edit', $ent->id)}}">
